...
#define MPU_RASR_SIZE_32M (25 << MPU_RASR_SIZE_SHIFT)
#define MPU_RASR_SIZE_1M (20 << MPU_RASR_SIZE_SHIFT)
#define MPU_RASR_SIZE_16M (24 << MPU_RASR_SIZE_SHIFT)
#define MPU_RASR_SIZE_256K (18 << MPU_RASR_SIZE_SHIFT)
...
void mpu_config(uint32_t sdram_base)
{
	...
	*MPU_RASR	= MPU_RASR_AP_RWRW |
	...
	/* Configure SRAM1 for DMA */
	*MPU_RNR	= 0x3;
	*MPU_RBAR	= 0x20020000;
	*MPU_RASR	= MPU_RASR_AP_RWRW |
					MPU_RASR_INT_RAM_ATTR|
					MPU_RASR_SIZE_256K |
					MPU_RASR_REG_ENABLE;
