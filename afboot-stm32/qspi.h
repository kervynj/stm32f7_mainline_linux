...
#define QUADSPI_CCR_SIOO(x) 		((x) << 28)
#define QUADSPI_CCR_DR(x) 		((x) << 31)

#define QUADSPI_CCR_IDMOD_1_LINE	QUADSPI_CCR_IDMODE(1)
#define QUADSPI_CCR_IDMOD_4_LINES 	QUADSPI_CCR_IDMODE(3)
#define QUADSPI_CCR_ADMOD_1_LINE	QUADSPI_CCR_ADMODE(1)
#define QUADSPI_CCR_ADMOD_4_LINES       QUADSPI_CCR_ADMODE(3)
#define QUADSPI_CCR_ABMODE_4_LINES	QUADSPI_CCR_ABMODE(3)
...
#define QUADSPI_CCR_SIOO_ENABLE		QUADSPI_CCR_SIOO(1)
#define QUADSPI_CCR_DDR			QUADSPI_CCR_DR(1) 
#define QUADSPI_CCR_SDR			QUADSPI_CCR_DR(0) 
...
#define QUAD_INPUT_OUTPUT_FAST_READ_CMD	0xeb
#define DTR_QUAD_OUTPUT_FAST_READ_CMD	0x6d
